                  ...
                  <div class="detail-info pr-30 pl-30">
                    ...
                    <div class="clearfix product-price-cover">
                      <div class="product-price primary-color float-left">
                        <span class="current-price text-brand">{{ one?.price }}$</span>
                        <span>
                    ...
                    <div class="detail-extralink mb-50">
                      <div class="detail-qty border radius">
                        <a href="#" class="qty-down" @click.prevent="decreaseQuantity">
                          <i class="fi-rs-angle-small-down"></i>
                        </a>
                        <input type="text" name="quantity" class="qty-val" v-model.number="quantity" min="1" />
                        <a href="#" class="qty-up" @click.prevent="increaseQuantity">
                    ...
                    <div class="font-xs">
                      <ul class="mr-50 float-start">
                        <li class="mb-5">
                          Type: <span class="text-brand">Organic</span>
                        </li>
                        <li class="mb-5">
                          MFG:<span class="text-brand"> Jun 4.2022</span>
                        </li>
...
export default defineComponent({
  data() {
    return {
      quantity: 1, // Set the initial quantity here, change it as needed
    };
  },
  computed: {
